...
public class S26PacketMapChunkBulk extends Packet
{
    ...
    public S26PacketMapChunkBulk(List p_i45197_1_)
    {
        ...
        if (i > 0) {
        	this.world = ((Chunk)p_i45197_1_.get(0)).worldObj;
        }
    ...
    public void compress()
    {
        ...
        {
                this.world.spigotConfig.antiXrayInstance.obfuscate(this.field_149266_a[i], this.field_149264_b[i], field_149265_c[i], this.field_149260_f[i], this.world);
        }

        int bufferLocation = 0;
        for (int j = 0; j < this.field_149266_a.length; j++) {
            System.arraycopy(this.field_149260_f[j], 0, this.field_149268_i, bufferLocation, (this.field_149260_f[j]).length);
            bufferLocation += (this.field_149260_f[j]).length;
        }
