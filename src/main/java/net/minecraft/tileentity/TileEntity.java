...
public class TileEntity
{
    ...
    public CrucibleTickManager.TileStopwatch myStopwatch;
    ...
    //Crucible - Let's make easier to identify a tile when it's printed
    public String toStringButDifferent() {
        GameRegistry.UniqueIdentifier id = GameRegistry.findUniqueIdentifierFor(blockType);
        return "TileEntity{" +
                "worldObj=" + worldObj +
                ", GC=" + GC +
                ", xCoord=" + xCoord +
                ...
                (", blockType=" + id == null ? "null":id.toString()) +
                ", isVanilla=" + isVanilla +
                '}';
    }
}